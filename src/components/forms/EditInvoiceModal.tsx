...
import { updateInvoice } from "@/lib/supabase/mutations";
import { formatCurrency } from "@/lib/format";
import type { Customer, Invoice, InvoiceStatus, Vehicle } from "@/lib/types";
  ...
  return (
    <>
      <button
        ...
        className="flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-700 shadow-sm transition-colors hover:bg-slate-50"
      >
      ...
      <Modal
        ...
        title="Edit Invoice"
        subtitle={`Update details for ${invoice.number}`}
        icon={Pencil}
        maxWidth="max-w-2xl"
      >
